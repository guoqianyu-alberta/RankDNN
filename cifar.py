...
class MetaCIFAR100(CIFAR100_v1):
...
if __name__ == '__main__':
    ...
    args.n_queries = 12
    # args.data_root = 'data'
    args.data_root = '/home/guoqy/CIFAR-FS'
    args.data_aug = True
    args.n_test_runs = 5
...
#    os._exit(1)
    ...
    metaimagenet = MetaCIFAR100_toy(args, 'train')
#    print(len(metaimagenet))
#    metaimagenet.__getitem__(500)
